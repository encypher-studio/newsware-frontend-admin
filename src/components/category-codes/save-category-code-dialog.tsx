...
export function SaveCategoryCodeDialog() {
    ...
    const handleSubmit = () => {
        if (!selectedCategoryCode) {
            apiService.createCategoryGroup({
                code: code,
                ...
                toast({ title: `Failed to create category code: ${e.message}`, variant: 'destructive' })
            })
            return
        }

        apiService.putCategoryCode({
            code: code,
            description: description,
        }).then(() => {
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input disabled={!!selectedCategoryCode} id="code" value={code} className="col-span-3" onChange={e => setCode(e.target.value)} />
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
